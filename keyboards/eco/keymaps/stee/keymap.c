 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Lower |    Bksp     |Pg-dwn| Pg-up|     Space   |Raise |  Up  | Down | Ctrl |
 * `-------------------------------------------------------------------------------------------------'
 */
[_COLEMAK] = {
  {KC_TAB  ,  	  KC_Q,   KC_W,    KC_F,    KC_P,  KC_G,   KC_LPRN, KC_RPRN,  KC_J,   KC_L,  KC_U,    KC_Y,    KC_SCLN, KC_BSLS},
  {MT1     ,      KC_A,   KC_R,    KC_S,    KC_T,  KC_D,   KC_LBRC, KC_RBRC,  KC_H,   KC_N,  KC_E,    KC_I,    KC_O,    KC_QUOT},
  {MOD_LSFT,      KC_Z,   KC_X,    KC_C,    KC_V,  KC_B,   KC_LCBR, KC_RCBR,  KC_K,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, MT2    },
  {KC_LCTL,       KC_LGUI,KC_LALT, LOWER,          KC_SPC, KC_LEFT, KC_RIGHT,         KC_SPC,RAISE,   KC_UP,   KC_DOWN, KC_RCTL}
},
