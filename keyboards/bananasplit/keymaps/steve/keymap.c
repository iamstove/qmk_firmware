...
[1] = KEYMAP( \
    ...
    ______,  KC_LEFT, KC_DOWN, KC_RGHT,  ______, ______, ______, KC_LPRN, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC,     KC_RPRN, \
...
[2] = KEYMAP( \
    ...
    ______,    ______,  ______,  ______,  ______, ______,  ______, ______,   ______,  ______, ______, KC_VOLU, ______, \
